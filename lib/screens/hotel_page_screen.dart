...
class HotelPageScreen extends StatefulWidget {
  ...
  @override
  _HotelPageScreenState createState() => _HotelPageScreenState();
}
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          const Text(
                            "\" Ambiente interessante e bem localizado, apenas acho que pode melhorar na questão dos agendamentos prévios!\"",
                            style: TextStyle(
                                fontSize: 14,
                                fontStyle: FontStyle.italic,
                                color: Colors.grey),
